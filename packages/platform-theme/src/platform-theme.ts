...
const theme = {
  ...
  shadows: {
    'sm-1': `${dropShadow['sm-1'].value.x}px ${dropShadow['sm-1'].value.y}px ${dropShadow['sm-1'].value.blur}px ${dropShadow['sm-1'].value.spread}px ${color['potential-midnight'].value}10`,
    'md-1': `${dropShadow['md-1'].value.x}px ${dropShadow['md-1'].value.y}px ${dropShadow['md-1'].value.blur}px ${dropShadow['md-1'].value.spread}px ${color['potential-midnight'].value}10`,
    'lg-1': `${dropShadow['lg-1'].value.x}px ${dropShadow['lg-1'].value.y}px ${dropShadow['lg-1'].value.blur}px ${dropShadow['lg-1'].value.spread}px ${color['potential-midnight'].value}10`,
    'xl-1': `${dropShadow['xl-1'].value.x}px ${dropShadow['xl-1'].value.y}px ${dropShadow['xl-1'].value.blur}px ${dropShadow['xl-1'].value.spread}px ${color['potential-midnight'].value}10`,
    'sm-2': `${dropShadow['sm-2'].value.x}px ${dropShadow['sm-2'].value.y}px ${dropShadow['sm-2'].value.blur}px ${dropShadow['sm-2'].value.spread}px ${color['potential-midnight'].value}20`,
    'md-2': `${dropShadow['md-2'].value.x}px ${dropShadow['md-2'].value.y}px ${dropShadow['md-2'].value.blur}px ${dropShadow['md-2'].value.spread}px ${color['potential-midnight'].value}20`,
  },
...
for (const key in iconLibrary) {
  iconLibraryObjectArray.push({ name: key, item: iconLibrary[key] });
}
